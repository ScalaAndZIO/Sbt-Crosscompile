...
@"__trait_has_trait" = external constant [323 x [323 x i1]]
...
_5.0:
  %_6 = bitcast i8* bitcast ([2002 x [323 x i1]]* @"__class_has_trait" to i8*) to [2002 x [323 x i1]]*
  %_7 = getelementptr [2002 x [323 x i1]], [2002 x [323 x i1]]* %_6, i32 0, i32 %_1, i32 %_2
...
_5.0:
  %_6 = bitcast i8* bitcast ([323 x [323 x i1]]* @"__trait_has_trait" to i8*) to [323 x [323 x i1]]*
  %_7 = getelementptr [323 x [323 x i1]], [323 x [323 x i1]]* %_6, i32 0, i32 %_1, i32 %_2
  %_3 = bitcast i1* %_7 to i8*
  %_8 = bitcast i8* %_3 to i1*
  %_4 = load i1, i1* %_8
  ret i1 %_4
